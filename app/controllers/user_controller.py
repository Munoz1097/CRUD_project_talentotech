...
# username, user_id, first_name, last_name, user_password, email, user_status
# Definir el modelo de usuario para la documentación de Swagger
user_model = user_ns.model('User', {
    'username': fields.String(required=True, description='Nombre de usuario'),
    'first_name': fields.String(required=True, description='Primer nombre del usuario'),
    'last_name': fields.String(required=True, description='Primer apellido del usuario'),
    'user_password': fields.String(required=True, description='Contraseña'),
    'email': fields.String(required=True, description='Email'),
    'user_status': fields.Boolean(required=True, description='Estado del usuario')
})
...
class UserResource(Resource):
    ...
    def post(self):
        ...
        user = UserService.create_user(data['username'], data['first_name'], data['last_name'], data['user_password'] , data['email'], data['user_status'])
