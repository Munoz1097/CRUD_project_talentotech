...
class UserService:
    @staticmethod
    def create_user( username, first_name, last_name, user_password, email, user_status):
        """
        ...
        user = User(username=username, user_password=hashed_password, first_name=first_name , last_name=last_name, email=email, user_status=user_status)
